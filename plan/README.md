...
| --- | --- | --- | --- | --- | --- |
| 2026-07-17 | [mToken SDK Readiness](./2026-07-17-mtoken-sdk-readiness.md) | Make Tang Rat mToken login resilient to delayed SDK/native-bridge initialization. | Implemented | TypeScript and focused ESLint passed; affected-device UAT test pending. | Implemented |
